...
167.44
#### Objects can write over each other
...
# greater or less > <
# greater than or equal to or less than or equal tow => <=
```
...
# This happens because the inclusion of a character in the data set makes the whole data type character. There is a hierarchy when there are mixed types, and character comes first.
```

How many values in combined_logical are "TRUE" (as a character) in the following example: 1 value 
```{r}
...
You’ve probably noticed that objects of different types get converted into a single, shared type within a vector. In R, we call converting objects from one class into another class coercion. These conversions happen according to a hierarchy, whereby some types get preferentially coerced into other types. What is the order of the hierarchy? The hierarchy is character, number, logical

```{r}
# Build a vector of the study semesters: 
study_semesters <- c("W2015", "F2015", "W2016", "F2016", "W2017", "F2017", "W2018", "F2018", "W2019", "F2019")
# Build a vector where the supplements consumed matches the order of the study semesters: 
supplements_consumed <- c("RPS", "MS, RPS, Inulin, Arabinoxylan", "RPS", "RPS", "RMS, Inulin, Accessible", "RPS, HiMaize, banana", "HiMaize", "RPS, RMS", "RPS", "RPS")
...
age_collegestudents <- c(18, 19, 20, 21, 22)

# Confirm this is numeric
class(age_collegestudents)
# The output was numeric 

# Convert this vector to character:
age_collegestudents <- c(18, 19, 20, 21, 22, "V")
```
